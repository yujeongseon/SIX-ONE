...
DROP TABLE timeline_sub CASCADE CONSTRAINTS;
...
(
	...
	FOOD_WHEN varchar2(1),
	FOOD_NAME nvarchar2(1000),
	FOOD_KCAL number,
	FOOD_DATE date,
	id varchar2(20) NOT NULL,
	PRIMARY KEY (FOOD_NO)
