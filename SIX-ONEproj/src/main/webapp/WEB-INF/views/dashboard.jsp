...
<head>
    ...
    <link rel="icon" type="image/png" href='<c:url value="/resources/assets/img/favicon.ico"/>'>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <title>씨에스에스먹히는지</title>
...
<script src="<c:url value='/resources/assets/js/light-bootstrap-dashboard.js?v=2.0.0' />"></script>
